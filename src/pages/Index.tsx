      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            {/* CTA Content */}
            <div className="relative overflow-hidden rounded-3xl gradient-primary p-12 text-center lg:text-left">
              <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" />
              <div className="relative z-10">
                <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                  Ready to Ace Your Exams?
                </h2>
                <p className="text-primary-foreground/80 max-w-xl mx-auto lg:mx-0 mb-8">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <Leaderboard className="max-w-md mx-auto lg:mx-0 lg:ml-auto" />
            </div>
          </div>
        </div>
      </section>
